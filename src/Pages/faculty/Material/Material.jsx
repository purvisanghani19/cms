...
const Material = () => {
  ...
  const [facmat, setFacmat] = useState([]);
                      ...
                      <tbody>
                        {
                          facmat.map((item) => (
                            ...
                            {item.id}
                              ...
                              <td class="text-center">{item.typeOfFile}</td>
                       ...
                       {/* <tr>
                          ...
                          <td class="text-center">ghgv</td>
                          <td class="text-center">fhfghb</td>
                          <td class="text-center">fgfgh</td>
                          <td class="text-center">fhgcfh</td>
