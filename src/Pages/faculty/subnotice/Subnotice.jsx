...
const Subnotice = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:4000/api/use/student/studentLeaveNotice/get").then((result) => {
            ...
            <div className="subnotice mt-5" style={{ marginLeft: "268px" }}>
                <div className="col-xl-8" style={{ textAlign: "start" }}>
                    <div className="card mb-4">
                        <div className="card-header " style={{ backgroundColor: " #263159", color: "white" }}>Leave notice date:</div>
